...
const FX_STORAGE_KEY = 'gina.ttsfx.v2'      // 音效参数（手感）；v2＝金属感默认调高+新增金属/Flanger参数
const FX_VOICES_KEY = 'gina.ttsfx.voices'   // 哪些音色开启了音效（音色 ID 列表）
...
const UNLOCK_KEY = 'gina.ttsfx.unlocked'
