        ...
        <div class="settings-tab active" data-tab="appearance">
          ...
          <div class="settings-section">
            ...
            <div class="settings-row">
              ...
              <input class="settings-input" id="settings-agent-name" type="text" maxlength="32" autocomplete="off" spellcheck="false" placeholder="Gina">
            </div>
    ...
    "timeoutMs": 60000
        ...
        <div class="settings-tab" data-tab="advanced">
          <div class="settings-section">
            ...
            <p class="settings-hint">控制 Gina 是否按固定节奏自主思考。关闭后不会再自动触发 L2 心跳，但用户消息和定时提醒仍会正常处理。</p>
            <div class="settings-row">
