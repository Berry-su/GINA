...
const previousPrivateNetwork = process.env.GINA_BROWSER_PRIVATE_NETWORK
...
try {
  process.env.GINA_BROWSER_PRIVATE_NETWORK = '0'
  ...
  process.env.GINA_BROWSER_PRIVATE_NETWORK = '1'
  ...
  if (previousPrivateNetwork === undefined) delete process.env.GINA_BROWSER_PRIVATE_NETWORK
  else process.env.GINA_BROWSER_PRIVATE_NETWORK = previousPrivateNetwork
}
