...
export function getEmbeddedBrowserBridge({
  bridge = globalThis.ginaBrowserEmbedBridge,
} = {}) {
...
function sidecarEnvironment(target, mcpConfig, source = process.env) {
  ...
  env.GINA_EMBEDDED_PLAYWRIGHT_TARGET = JSON.stringify(target)
  env.GINA_EMBEDDED_PLAYWRIGHT_CONFIG = JSON.stringify(mcpConfig || {})
