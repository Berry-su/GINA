...
process.env.GINA_USER_DIR = tempRoot
process.env.GINA_ALLOW_LAN = '1'
process.env.GINA_API_TOKEN = 'test-lan-pairing-token'
process.env.GINA_PORT = '4567'
...
try {
  ...
  delete process.env.GINA_USER_DIR
  delete process.env.GINA_ALLOW_LAN
  delete process.env.GINA_API_TOKEN
