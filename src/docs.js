...
export function buildDocPanelStateContext(detectedTopic = null) {
  ...
  const lines = [
    ...
    `- When the user needs voice, model, WeChat, or social-platform configuration help, choose the matching topic and open the panel: voice_asr, voice_tts, voice_config, model_config, or wechat_config. When the user asks about how Gina works, its code architecture, or its internal mechanisms, open self_architecture. When the user asks about Gina's interface, panels, or Scene/visual design, open ui_design.`,
