...
const NOTICE_TITLE = 'Gina 安全存储说明'
...
function noticeContent(purpose = 'secure-data') {
  if (purpose === 'browser-profile') {
    return {
      ...
      detail: [
        'Gina 即将使用 macOS 钥匙串读取和保存自带浏览器的 Cookie、会话及网站登录状态。',
        'macOS 随后可能要求输入你的 Mac 登录密码。密码只由 macOS 验证，Gina 无法读取，也不会上传。',
